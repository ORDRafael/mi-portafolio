...
export default function ExperienciaItems ({timeline, title, subtitle, description} : ExperienciaProps) {
    return(
        <div className='p-3 md:p-5 rounded-2xl mb-5 hover:bg-gray-900 hover:shadow-2xl transition-all duration-300'>
            <div className="flex flex-col md:flex-row gap-4 md:gap-10">
                ...
                <div className="flex flex-col">
                    ...
                    <p className='text-gray-600 font-medium text-base md:text-lg mt-2'>{description}</p>
                </div>
            </div>
        </div>
    );
